...
public class SocketsDatabaseAccessTest {
	...
	public void before() throws Exception {
		// Start server thread
		File orig = new File(SocketsDatabaseAccessConcurrencyTest.class.getResource("/").getPath(), "db-1x1.db");
		File file = new File(SocketsDatabaseAccessConcurrencyTest.class.getResource("/").getPath(), "db-1x1.db.test");
		FileUtils.copyFile(orig, file);
		server = new SocketServer(PORT, file.getAbsolutePath());
		server.start();
	...
	public void testRead() throws Exception {
		SocketsDatabaseAccess client = new SocketsDatabaseAccess("localhost", PORT);
	...
	public void testCreate() throws Exception {
		...
		SocketsDatabaseAccess client2 = new SocketsDatabaseAccess("localhost", PORT);
	...
	// SocketsDatabaseAccess client = new SocketsDatabaseAccess("localhost",
	// PORT);
	// try {
